...
export default class LoginContainer extends Component {
  ...
  handlePressRegister = async () => {
    ...
    if (result) {
      setTimeout(async () => {
        const loginResult = await UserService.login(result.email, result.password);
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableHighlight style={styles.buttonContainer} onPress={() => navigate(SCREEN_NAMES.LOGIN)}>
